...
The repo now includes a Playwright flow that starts this FastAPI backend and the Next.js frontend together, then validates homepage, skills, bundle, docs search/filter, teaching, project-doc, ordered command-runbook, and command-copy flows against the real API:
