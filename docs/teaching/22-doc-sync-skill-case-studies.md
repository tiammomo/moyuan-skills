...
1. 先读 [../yuque-openapi.md](../yuque-openapi.md)
2. 再读 [../feishu-doc-sync.md](../feishu-doc-sync.md)
3. 然后对照 [../skill-learning-guide.md](../skill-learning-guide.md)
4. 最后回到 [03-build-your-first-skill.md](./03-build-your-first-skill.md) 或 [11-skill-author-path.md](./11-skill-author-path.md)
...
5. 在动手写自己的 skill 前，再回看 [../skill-quickstart.md](../skill-quickstart.md) 和 [../skill-authoring.md](../skill-authoring.md)

## 最小实践建议

如果你想把这两个案例真正用来学习，不只是浏览文档，建议做下面这组最小实践：

1. 先读 [../yuque-openapi.md](../yuque-openapi.md)，并浏览 `skills/yuque-openapi/`
2. 再读 [../feishu-doc-sync.md](../feishu-doc-sync.md)，并浏览 `skills/feishu-doc-sync/`
3. 用 [../skill-design-template.md](../skill-design-template.md) 给你自己的目标 skill 做一版结构草图
4. 最后回到 [../skill-quickstart.md](../skill-quickstart.md)，开始做最小可用版本
