...
如果你在 `README.md`、`skill-quickstart.md` 或 `teaching/` 里看到一些词不太确定含义，先看这里。
...
- 想继续按新人路径学：进入 [10-learner-path.md](./10-learner-path.md)
- 想开始做第一个 skill：进入 [03-build-your-first-skill.md](./03-build-your-first-skill.md)
