...
1. 学习层
   入口在 `docs/README.md`、`docs/teaching/README.md` 和各主题子目录，负责解释方法论、课程顺序和练习路径。
2. 案例层
...
3. [01-learning-map.md](../foundations/01-learning-map.md)
4. [02-read-the-repo.md](../foundations/02-read-the-repo.md)
5. [03-build-your-first-skill.md](../foundations/03-build-your-first-skill.md)
...
1. [03-build-your-first-skill.md](../foundations/03-build-your-first-skill.md)
2. [skill-authoring.md](../../authoring/skill-authoring.md)
3. [04-progressive-disclosure-workshop.md](../foundations/04-progressive-disclosure-workshop.md)
...
1. [12-maintainer-path.md](../roles/12-maintainer-path.md)
2. [08-evals-and-prototypes.md](./08-evals-and-prototypes.md)
3. [../repo-commands.md](../../setup/repo-commands.md)
4. [../dev-setup.md](../../setup/dev-setup.md)
...
1. [05-harness-roadmap.md](../foundations/05-harness-roadmap.md)
2. [08-evals-and-prototypes.md](./08-evals-and-prototypes.md)
3. [../harness-engineering.md](../../harness/harness-engineering.md)
4. [../harness-prototypes.md](../../harness/harness-prototypes.md)
...
- 想先完成新人 onboarding：进入 [14-first-hour-onboarding.md](../onboarding/14-first-hour-onboarding.md)
- 想开始实操写 skill：进入 [03-build-your-first-skill.md](../foundations/03-build-your-first-skill.md)
- 想理解案例梯度：进入 [07-case-gradient.md](./07-case-gradient.md)
- 想理解系统层：进入 [08-evals-and-prototypes.md](./08-evals-and-prototypes.md)
- 想理解项目为什么继续往 market 演进：进入 [16-skills-market-evolution.md](../market/16-skills-market-evolution.md)
- 想直接按角色进入：进入 [10-learner-path.md](../roles/10-learner-path.md)、[11-skill-author-path.md](../roles/11-skill-author-path.md)、[12-maintainer-path.md](../roles/12-maintainer-path.md) 或 [13-harness-builder-path.md](../roles/13-harness-builder-path.md)
