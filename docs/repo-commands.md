...
其中 `npm run e2e --prefix frontend` 会通过 Playwright 同时拉起 FastAPI backend 和 Next.js frontend，验证首页、skills、bundle、docs 搜索/筛选、teaching、project docs，以及详情页 related navigation、context panel、ordered action panel 和命令复制交互这几条核心前后端链路。
