...
- docs action panel 的 allowlist backend 执行、copy fallback、前置条件状态、recent runs compare / filter、run diff summary、section diff 状态、quick-open handoff、last-success，以及 artifact / stdout / stderr 结果钻取
