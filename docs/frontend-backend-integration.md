...
That same shared payload now also supports detail-page related navigation, context panels, and copy-friendly action panels without requiring separate recommendations or metadata endpoints.
...
- doc detail pages expose action panels with concrete repo commands, copy buttons, and next-step links
...
- shared action panels with command-copy affordances on detail pages
