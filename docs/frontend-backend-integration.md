...
That same shared payload now also supports detail-page related navigation, context panels, and action panels without requiring separate recommendations or metadata endpoints.
...
- doc detail pages expose action panels with concrete repo commands and next-step links
...
- shared action panels on detail pages
