...
当前远端 browse 的用户入口主要是 CLI、Python backend 和 Next.js 代理层；前端 `/registries/*` 页面仍然属于剩余工作。
...
- waiver audit 的 finding 也可以继续被翻译成 remediation 建议，帮助 client-side 维护者明确下一步该续期、删除还是重写 waiver
